...
<body class="bg-gray-50">
 ...
 <main class="flex-grow max-w-7xl mx-auto px-6 py-12">
  <h2 class="text-3xl font-semibold mb-4 text-farm-dark text-center">🌾Real-Time Agricultural Prices</h2>
  <div class="shop-section px-4 pt-8 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
    ...
    >
      <div
        class="h-48 relative overflow-hidden bg-gradient-to-br from-blue-400 to-blue-600"
      >
        <img
          src="mp6.jpg"
          alt="Local Price"
        ...
        />
        <div
          class="absolute inset-0 bg-blue-500 hidden items-center justify-center"
        >
          <i class="fas fa-tag text-6xl text-white opacity-80"></i>
        </div>
        <div
          class="absolute inset-0 bg-black bg-opacity-20 group-hover:bg-opacity-10 transition-opacity"
        ></div>
      </div>
      <div class="p-6">
        <h3 class="text-xl font-bold text-gray-800 mb-2">Local Price</h3>
        <p class="text-gray-600 text-sm mb-4">Check local market prices near you.</p>
        <div
          class="flex items-center text-blue-600 group-hover:text-blue-800 transition-colors"
        >
    ...
    <!-- National Price Box -->
    <a
      href="nationalprice.php"
      class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow group cursor-pointer"
    >
      <div
        class="h-48 relative overflow-hidden bg-gradient-to-br from-purple-400 to-purple-600"
      >
        <img
          src="mp4.jpg"
          alt="National Price"
        ...
        />
        <div
          class="absolute inset-0 bg-purple-500 hidden items-center justify-center"
        >
          <i class="fas fa-globe text-6xl text-white opacity-80"></i>
        </div>
        <div
          class="absolute inset-0 bg-black bg-opacity-20 group-hover:bg-opacity-10 transition-opacity"
        ></div>
      ...
      <div class="p-6">
        <h3 class="text-xl font-bold text-gray-800 mb-2">National Price</h3>
        <p class="text-gray-600 text-sm mb-4">View prices across the country.</p>
        <div
          class="flex items-center text-purple-600 group-hover:text-purple-800 transition-colors"
        >
          <span class="text-sm font-semibold">Explore</span>
          <i class="fas fa-arrow-right ml-2 text-xs"></i>
        </div>
    ...
    >
      <div
        class="h-48 relative overflow-hidden bg-gradient-to-br from-yellow-400 to-yellow-600"
      >
        <img
          src="mp2.webp"
        ...
        />
        <div
          class="absolute inset-0 bg-yellow-500 hidden items-center justify-center"
        >
          <i class="fas fa-balance-scale text-6xl text-white opacity-80"></i>
        </div>
        <div
          class="absolute inset-0 bg-black bg-opacity-20 group-hover:bg-opacity-10 transition-opacity"
        ></div>
      ...
      <div class="p-6">
        <h3 class="text-xl font-bold text-gray-800 mb-2">Price Comparison</h3>
        <p class="text-gray-600 text-sm mb-4">Compare prices from different markets.</p>
        <div
          class="flex items-center text-yellow-600 group-hover:text-yellow-800 transition-colors"
        >
          <span class="text-sm font-semibold">Explore</span>
          <i class="fas fa-arrow-right ml-2 text-xs"></i>
        </div>
