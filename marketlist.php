...
<main class="flex-grow max-w-7xl mx-auto px-6 py-12">
  <h2 class="text-3xl font-semibold mb-4 text-farm-dark text-center">🌱Farm Produce Marketplace</h2>

  <div class="shop-section px-4 pt-8 grid gap-8 md:grid-cols-2 lg:grid-cols-3">

    <?php if (in_array($role, ['farmer', 'buyer', 'admin'])): ?>
    <!-- Market List Box -->
    <a href="mlist.php" class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow group cursor-pointer">
      <div class="h-48 relative overflow-hidden bg-gradient-to-br from-green-400 to-green-600">
        <img src="mp6.jpg" alt="Market List" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
      ...
      <div class="p-6">
        <h3 class="text-xl font-bold text-gray-800 mb-2">Market LIST</h3>
        <p class="text-gray-600 text-sm mb-4">Explore available crops and market details.</p>
    ...
    <?php if ($role === 'farmer'): ?>
    <!-- My Crops Dashboard Box -->
    <a href="mlistdashboard.php" class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow group cursor-pointer">
      <div class="h-48 relative overflow-hidden bg-gradient-to-br from-green-400 to-green-600">
        <img src="c4.jpg" alt="My Crops Dashboard" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
             onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';" />
        <div class="absolute inset-0 bg-green-500 hidden items-center justify-center">
      ...
      <div class="p-6">
        <h3 class="text-xl font-bold text-gray-800 mb-2">MyCrops Dashboard</h3>
        <p class="text-gray-600 text-sm mb-4">Manage and track your crops efficiently.</p>
        <div class="flex items-center text-farm-green group-hover:text-farm-dark transition-colors">
          <span class="text-sm font-semibold">Go to Dashboard</span>
          <i class="fas fa-arrow-right ml-2 text-xs"></i>
        </div>
      </div>
    </a>
    ...
    <?php if (in_array($role, ['farmer', 'buyer', 'admin'])): ?>
    <!-- Seed & Fertilizer List Box -->
    <a href="sf_list.php" class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow group cursor-pointer">
      <div class="h-48 relative overflow-hidden bg-gradient-to-br from-green-400 to-green-600">
        <img src="seedpic1.jpeg" alt="Seed and Fertilizer" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
             onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';" />
        <div class="absolute inset-0 bg-green-500 hidden items-center justify-center">
      ...
      <div class="p-6">
        <h3 class="text-xl font-bold text-gray-800 mb-2">Seed & Fertilizer</h3>
        <p class="text-gray-600 text-sm mb-4">View available seeds and fertilizers.</p>
        <div class="flex items-center text-farm-green group-hover:text-farm-dark transition-colors">
    ...
    <?php if ($role === 'admin'): ?>
    <!-- Admin Dashboard Box -->
    <a href="seedadmindashboard.php" class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow group cursor-pointer">
      <div class="h-48 relative overflow-hidden bg-gradient-to-br from-green-400 to-green-600">
