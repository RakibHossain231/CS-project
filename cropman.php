...
<body class="bg-gray-50">
  ...
  <div>
   ...
   <h2 class="text-3xl font-semibold mb-4 text-farm-dark ">Crop Mangment</h2></div>

  <!-- Shop Section -->
  <div
    class="shop-section px-4 pt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3"
  >
    ...
    >
      <div
        class="h-48 relative overflow-hidden bg-gradient-to-br from-green-400 to-green-600"
      >
        <img
          src="c1.jpg"
          alt="Crop LIST"
        ...
        />
        <div
          class="absolute inset-0 bg-green-500 hidden items-center justify-center"
        >
          <i
            class="fas fa-leaf text-6xl text-white opacity-80"
          ></i>
        </div>
        <div
      ...
      <div class="p-6">
        <h3 class="text-xl font-bold text-gray-800 mb-2">Crop LIST</h3>
        <p class="text-gray-600 text-sm mb-4">
          Explore available crops and their details
        </p>
        <div
          class="flex items-center text-farm-green group-hover:text-farm-dark transition-colors"
        >
    ...
    >
      ...
      >
        ...
        >
          <i
            class="fas fa-tractor text-6xl text-white opacity-80"
          ></i>
        </div>
        <div
          class="absolute inset-0 bg-black bg-opacity-20 group-hover:bg-opacity-10 transition-opacity"
      ...
      <div class="p-6">
        <h3 class="text-xl font-bold text-gray-800 mb-2">Types Of Crops</h3>
        <p class="text-gray-600 text-sm mb-4">
          Different varieties grown across seasons
        </p>
        <div
          class="flex items-center text-farm-green group-hover:text-farm-dark transition-colors"
        >
    ...
    >
      ...
      >
        ...
        >
          <i
            class="fas fa-calendar text-6xl text-white opacity-80"
          ></i>
        </div>
        <div
          class="absolute inset-0 bg-black bg-opacity-20 group-hover:bg-opacity-10 transition-opacity"
      ...
      <div class="p-6">
        <h3 class="text-xl font-bold text-gray-800 mb-2">Seasonal Crops</h3>
        <p class="text-gray-600 text-sm mb-4">Track and plant crops based on season</p>
        <div
          class="flex items-center text-farm-green group-hover:text-farm-dark transition-colors"
        >
          <span class="text-sm font-semibold">Learn More</span>
    ...
    >
      ...
      >
        ...
        >
          <i
            class="fas fa-chart-line text-6xl text-white opacity-80"
          ></i>
        </div>
        <div
          class="absolute inset-0 bg-black bg-opacity-20 group-hover:bg-opacity-10 transition-opacity"
      ...
      <div class="p-6">
        ...
        <p class="text-gray-600 text-sm mb-4">
          Access personalized crop management tools
        </p>
        <div
          class="flex items-center text-farm-green group-hover:text-farm-dark transition-colors"
        >
